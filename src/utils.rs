...
//         Value::Sequence(seq) => J::Array(seq.iter().map(to_json).collect()),
//         Value::Mapping(map) => {
//             // Only string keys can round-trip to JSON object keys
//             let mut obj = serde_json::Map::new();
//             for (k, v) in map {
//                 if let Value::String(sk) = k {
//                     obj.insert(sk.clone(), to_json(v));
//                 }
//             }
//             J::Object(obj)
//         }
//         _ => serde_json::Value::Null, // tags/anchors/complex keys skipped in this tiny bridge
//     }
// }
...
//         serde_json::Value::Array(a) => Value::Sequence(a.iter().map(from_json).collect()),
//         serde_json::Value::Object(o) => {
//             let mut m = indexmap::IndexMap::new();
//             for (k, v) in o {
//                 m.insert(Value::String(k.clone()), from_json(v));
//             }
//             Value::Mapping(m)
//         }
//     }
